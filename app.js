...
function generateCodes() {
  ...
  if (qrText.trim() === "") {
    ...
    // Создание и добавление h1 "СЦ Астрахань" и span с датой и временем в один div
    var companyInfoDiv = document.createElement("div");
    companyInfoDiv.id = "company-info";
    var companyName = document.createElement("h1");
    companyName.textContent = "СЦ Астрахань"; // !Астрахань
...
function sendImageToTelegram() {
  const token = '8003267706:AAGrk9_UrJz4c4asR7oXr6UFjf8quM0QCQU';
  const chatId = '-1002724528495';
